  ...
  const loadTransactions = useCallback(async () => {
    ...
    try {
      ...
      try {
        ...
        console.warn("[Transactions] Primary endpoint failed:", primaryErr.message);
        endpoint = "/admin/bookings";
        console.log(`[Transactions] Fallback to: ${endpoint}`);
        response = await apiCall(endpoint);
        console.log("[Transactions] Fallback response:", response);
      }
